        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed text-center md:text-left">
                Transform your images effortlessly with our browser-based
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="/"
                    className="text-gray-600 hover:text-cyan-400 transition-colors flex items-center gap-2 group"
                  >
          ...
          <div className="pt-8 border-t border-gray-200 text-center">
            <p className="text-sm flex items-center justify-center gap-2 text-gray-600">
              © {currentYear}{" "}
              <span className="font-semibold text-cyan-500">Clearity</span>.
              Made with{" "}
              <Heart
                className="w-4 h-4 text-red-400 inline animate-pulse"
                fill="currentColor"
              />
              for creators.
            </p>
